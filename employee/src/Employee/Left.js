...
import user from "../assest/12.png";
import { NavLink } from "react-router-dom";
import { isActiveStyles, isnotActiveStyles } from "../Utils/Stlyes";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="/" className="flex items-center ms-2 md:me-24">
                <img src={Logo} className="h-8 me-3" alt="Tron Logo" />
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            <li><a
              ...
              > <FaUserTie /> <span class="ms-3">Create Employee</span>
              </a>
            </li>
            <li><a
                href="/admin/message"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              > <FaUserTie /> <span class="ms-3">Information</span>
              </a>
            </li>
            <li><a
                href="/admin/history"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              > <FaUserTie /> <span class="ms-3">Leave History</span>
              </a>
            </li>
          </ul>
        </div>
...
//                <span class="ms-3">Create Employee</span>
//             </a>
//          </li>
//          <li>
//             <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
