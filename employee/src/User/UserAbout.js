...
//             <h2 className="text-xl text-blue-400 ">Hello {user.name}!</h2>
//             <p>Your Details:</p>
//             <ul>
...
//           <button click="openSettings = !openSettings" className="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20" title="Settings">
...
//           <div x-show="openSettings" @click.away="openSettings = false" className="bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl" style={{display: 'none'}}>
        ...
        <div className="h-full bg-gray-200 p-8">
          <div className="bg-white rounded-lg shadow-xl pb-8 relative">
            <div className="absolute right-12 mt-4">
              <button onClick={toggleSettings} className="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20" title="Settings">
              <BsThreeDotsVertical />
            ...
            <div className="flex flex-col items-center -mt-20">
              ...
              <div className="flex items-center space-x-2 mt-2">
                ...
                <span className="bg-blue-500 rounded-full p-1" title="Verified"></span>
              </div>
